...
def _get_auth_header(signing_headers, method, path, api_key_id, secret_key):
    ...
    print("\nString to sign encode: ", string_to_sign.encode())
    ...
    print("\nb64_signed_auth_digest.decode:", b64_signed_auth_digest.decode('ascii'))
    auth_str += (
...
class IntersightAuth(AuthBase):
    ...
    def __call__(self, r):
        ...
        print("\nb64encode(digest):", b64encode(digest))
